...
import useSearchArticles from '../../../../hooks/searchHook/useSearchArticles';
...
const page = () => {
    ...
    const [slug, setSearchItem] = useState(null);
    const pageSize = 8;
    ...
    const { articles, loading, totalResults, error, pages, hasNext, hasPrevious } = useSearchArticles(slug, currentPage, pageSize);
                        ...
                        <div className="col">
                            <div className="search-results-header">
                                <div className="search-results-title">
                                    <span className="search-term">"{slug}"</span> aramanızla ilgili haberler
                                </div>
